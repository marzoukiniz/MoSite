    ...
    <div class="section_container">
        ...
        <section>
            ...
            <div id="main_content">
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li><a href="hotel.php">Fidelte</a></li>
			...
			<tr>
              ...
              <th class="align_center" >statut</th>
              <th class="align_center" >Niveau</th>
              <th class="align_center" >NBR RESERVATION</th>
...
<td width="10%"><c:out value="${r[0].client.nom}"/></td>
<td width="10%"><c:out value="${r[0].client.statut}"/></td>
<td width="10%"><c:out value="${r[0].client.niveau}"/></td>
      <td width="10%"> <input type="text" value="${x}"/></td>
