        ...
        <section>
            ...
            <div id="side_nav">
                <div class="sideNavCategories">
                    ...
                    <ul class="category departments">
                        ...
                        <li><a href="AjoutClient.jsp">Ajouter</a></li>
                   ...
                   <form name="search_form" method="GET" action="RechercheClient">
					Cherhcer : <br><br><input type="text" name="var" value="" placeholder="chercher nom client" required/><br><br>
            ...
            <div id="main_content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="hotel.php">client</a></li>
			...
			<tr>
              ...
              <th class="align_center" >nom</th>
              <th class="align_center" >prenom</th>
              <th class="align_center" >email</th>
              <th class="align_center" >cin</th>
              <th class="align_center" >login</th>
		      <th class="align_center" >password</th>
		      <th class="align_center"> Modifier </th>
		     <th class="align_center" width="6%"> Supprimer </th>
		      
            </tr>
            
       
<c:forEach var="Client" items="${l}">
<tr>
...
<td><a href="ModifClientServlet?id=${Client.id}">Modifier</a></td>
<td> 
<a href="DeleteClient?id=${Client.id}">sup</a></td>
