...
<form action="ModifClientServlet" method="Post">
Id :<br><input type="text" style="background-color:#E6E6E6"  name="id" readOnly value="${cl.id}"/><br><br>
Nom :<br><input type="text" style="background-color:#E6E6E6"  name="nom"  value="${cl.nom}"/><br><br>
Prenom:<br><input type="text" style="background-color:#E6E6E6"  name="prenom"  value="${cl.prenom}"/><br><br>
cin:<br><input type="number" style="background-color:#E6E6E6"  name="cin"  value="${cl.cin}"/><br><br>
Email:<br/><input type="text" style="background-color:#E6E6E6"  name="email"  value="${cl.email}"/><br/><br/>
login :<br><input type="text" style="background-color:#E6E6E6"  name="login"  value="${cl.login}"/><br><br>
password:<br><input type="text" style="background-color:#E6E6E6"  name="password"  value="${cl.password}"/><br><br>
niveau:<br><input type="text" style="background-color:#E6E6E6"  name="niveau"  value="${cl.niveau}"/><br><br>
statut:<br/><input type="text" style="background-color:#E6E6E6"  name="statut"  value="${cl.statut}"/><br/><br/>
