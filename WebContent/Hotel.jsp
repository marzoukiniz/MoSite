        ...
        <section>
            ...
            <div id="side_nav">
                <div class="sideNavCategories">
                    ...
                    <ul class="category departments">
                        ...
                        <li><a href="AjoutHotel.jsp">Ajouter</a></li>
                    ...
                    <ul class="category price">
                     ...
                     <form name="search_form" method="GET" action="Recherche">
					Cherhcer : <br><br><input type="text" name="price" value="" placeholder="chercher nom hotel" required/><br><br>
			...
			<tr>
			 <th class="align_center" >Image</th>
              ...
              <th class="align_center" >Grad</th>
              <th class="align_center" >Prix</th>
              <th class="align_center" >NbreChambres</th>
		      <th class="align_center" >Modifier</th>
			   <th class="align_center" >Supprimer</th>
       <th class="align_center" width="6%">details</th>
            </tr>
...
<tr>
<td><img src="images/hotels/${hotels.imaghot}" width="70" height="70"/></td>

<td><c:out value="${hotels.idHotel}"/></td>
...
<td><a href="ModifHotelServlet?id=${hotels.idHotel}">Modifier</a></td>
<td> 
<a href="DeleteHotel?id=${hotels.idHotel}">sup</a></td>
