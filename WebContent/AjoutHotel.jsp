    ...
    <div class="section_container">
        ...
        <section>
            ...
            <div id="main_content">
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li><a href="hotel.php">ajouter hotel</a></li>
...
<form action="AjoutHotelServlet" method="Post">

Nom Hotel:<br><input type="text" style="background-color:#E6E6E6"  name="nomh" required/><br><br>
Grade Hotel:<br><input type="number" style="background-color:#E6E6E6" required name="gradh"/><br><br>
Prix Hotel:<br><input type="number" style="background-color:#E6E6E6" required name="prixh"/><br><br>
Nombre des chambres:<br/><input type="number" style="background-color:#E6E6E6" required name="nbr"/><br/><br/>
Description:<br><input type="text" style="background-color:#E6E6E6" required name="desc"/><br><br>
Adresse:<br><input type="text" style="background-color:#E6E6E6" required name="adresse"/><br><br>
Ville:<br><input type="text" style="background-color:#E6E6E6" required name="ville"/><br><br>
