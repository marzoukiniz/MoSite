...
<form action="ModifHotelServlet" method="Post">

Id Hotel:<br><input type="text" style="background-color:#E6E6E6" value="${h.idHotel}" name="idh" readOnly/><br><br>
Nom Hotel:<br><input type="text" style="background-color:#E6E6E6" value="${h.nomHotel}" name="nomh"/><br><br>
Grade Hotel:<br><input type="number" style="background-color:#E6E6E6" value="${h.gradhotel}" name="gradh"/><br><br>
Prix Hotel:<br><input type="number" style="background-color:#E6E6E6" value="${h.prixhotel}" name="prixh"/><br><br>
Nombre des chambres:<br/><input type="number" style="background-color:#E6E6E6" value="${h.nbrChambres}" name="nbr"/><br/><br/>
Image Hotel:<br><img src="images/hotels/${h.imaghot}" width=150 height=150/><br><br>
