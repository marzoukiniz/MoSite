    ...
    <div class="section_container">
        ...
        <section>
            ...
            <div id="side_nav">
                <div class="sideNavCategories">
                    ...
                    <ul class="category departments">
                        <li class="header">Ajouter client</li>
                    ...
                    <ul class="category price">
                        <li class="header">Cherhcer client</li>
            ...
            <div id="main_content">
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li><a href="hotel.php">ajouter client</a></li>
...
Nom :<br><input type="text" style="background-color:#E6E6E6"  required name="nom"/><br><br>
Prenom:<br><input type="text" style="background-color:#E6E6E6" required  name="prenom"/><br><br>
cin:<br><input type="number" style="background-color:#E6E6E6" required name="cin"/><br><br>
Email:<br/><input type="text" style="background-color:#E6E6E6" required name="email"/><br/><br/>
login :<br><input type="text" style="background-color:#E6E6E6" required name="login"/><br><br>
password:<br><input type="password" style="background-color:#E6E6E6" required name="password"/><br><br>
niveau:<br><input type="text" style="background-color:#E6E6E6" required name="niveau"/><br><br>
statut:<br/><input type="text" style="background-color:#E6E6E6" required name="statut"/><br/><br/>
